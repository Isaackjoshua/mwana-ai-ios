...
class SegmentationResult {
  ...
  /// Values are 0.0 (background) or 1.0 (lesion) after thresholding.
  final Float32List binaryMask;

  /// RGBA PNG bytes of the coloured overlay rendered on the original image.
  /// Null until OverlayRenderer processes the mask.
  ...
  /// Width and height of the binary mask (always 256 from the ONNX model).
